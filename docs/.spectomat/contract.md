...
Repository: `/Users/alex/Projects/spectomat-todo`
...
If a phase defeats you, append `(strike N)` to its log line and skip it next
...
No code in this phase, and no questions: where the draft is silent, decide
and record.
